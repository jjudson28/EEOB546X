...
```{r}
meltedgraphsummary <- dcast(graphsummary, Group ~SNPStatus, value.var = "SNP_Number")
colnames(meltedgraphsummary)[4] <- "Missing"
meltedgraphsummary
```

The ZMMLR Group has the most heterozygous individuals across loci.
...
##Visualize an aspect of my choice: candidate versus random designation across chromosomes
